    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>pemeriksaan" method="post">
                <div class="mb-3">
                    <label for="pendaftaran_id" class="form-label">Data Antrean Pasien (Hanya yang berstatus Menunggu)</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control <?= $validation->hasError('tanggal_periksa') ? 'is-invalid' : '' ?>" id="tanggal_periksa" name="tanggal_periksa" value="<?= old('tanggal_periksa', date('Y-m-d')) ?>">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= $validation->hasError('diagnosa') ? 'is-invalid' : '' ?>" id="diagnosa" name="diagnosa" rows="3"><?= old('diagnosa') ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= $validation->hasError('tindakan') ? 'is-invalid' : '' ?>" id="tindakan" name="tindakan" rows="3"><?= old('tindakan') ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= $validation->hasError('resep_obat') ? 'is-invalid' : '' ?>" id="resep_obat" name="resep_obat" rows="3"><?= old('resep_obat') ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= $validation->hasError('catatan') ? 'is-invalid' : '' ?>" id="catatan" name="catatan" rows="2"><?= old('catatan') ?></textarea>
                    <div class="invalid-feedback">
